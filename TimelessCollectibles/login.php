...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if ($email == $adminEmail && $password == $adminPassword) {
        ...
        if ($result->num_rows > 0) {
            $_SESSION['email'] = $email; // Starting the session for non-admin users
            header("Location: user_2FA.php");
            exit;
        } else {
...
<head>
    ...
    <title>Log in - Timeless Collectibles</title>
                            ...
                            <form method="post" action="login.php">
                                ...
                                <div class="mb-3">
                                    <button class="btn btn-primary shadow d-block w-100" type="submit"
                                        style="border-color: rgb(25, 245, 170); border-top-color: rgb(255,; border-right-color: 255,; border-bottom-color: 255); border-left-color: 255,; background: rgb(25, 245, 170); color: rgb(0, 0, 0);">Log
                                        in</button>
                                </div>
                            </form>
                            <a href="forgot_password.php" style="text-decoration: none;">
                                <p class="text-muted" style="color: rgb(25, 245, 170);">Forgot your password?</p>
                            </a>
                        </div>
                    </div>
                </div>
