...
<body>
    ...
    <div class="col-md-8 col-xl-6 text-center mx-auto">
        <h1 class="fw-bold bounce animated" style="color: rgb(25, 245, 170);">Action Figurines</h1>
        <p class="text-muted">"Level up your display, widen your collection with our action figurines!"</p>
    </div>
    <section class="py-5">
        <div class="container py-5">
            ...
            <div id="figurinesContainer" class="row">
                <?php
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
            ?>
                <div class="col-lg-4 mb-4 figurine-item">
                ...
                echo "No products found in the 'Figurines' category.";
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var figurinesContainer = document.getElementById('figurinesContainer');

        searchInput.addEventListener('input', function() {
            var filter = searchInput.value.toLowerCase();
            var figurines = figurinesContainer.getElementsByClassName('figurine-item');

            Array.from(figurines).forEach(function(figurine) {
                var title = figurine.querySelector('.card-title').textContent.toLowerCase();
                var description = figurine.querySelector('.card-text').textContent
            .toLowerCase();
                if (title.includes(filter) || description.includes(filter)) {
                    figurine.style.display = '';
                } else {
