...
<body>
                ...
                <div class="col-md-6 col-xl-4" data-aos="fade">
                    <div class="card">
                        <div class="card-body text-center d-flex flex-column align-items-center">
                            <h3 class="fw-bold bounce animated mb-0" style="color: rgb(25, 245, 170);">Reset Password
                            </h3>
                            ...
                            <form method="post" action="process_reset_password.php" onsubmit="return validateForm()">
                                ...
                                <button class="btn btn-primary shadow d-block w-100" type="submit"
                                    style="border-color: rgb(25,245,170);border-top-color: rgb(255,;border-right-color: 255,;border-bottom-color: 255);border-left-color: 255,;background: rgb(25,245,170);color: rgb(0,0,0);">Send</button>
                            </form>
                        </div>
                    </div>
                </div>
    ...
    function validateForm() {
        ...
        if (!validatePassword(password)) {
            alert("Password must be at least 8 characters long, contain an uppercase letter, and a symbol");
            return false;
        }
