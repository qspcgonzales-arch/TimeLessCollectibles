...
<body>
    ...
    <div class="col-md-8 col-xl-6 text-center mx-auto">
        <h1 class="fw-bold bounce animated" style="color: rgb(25, 245, 170);">Cards</h1>
        <p class="text-muted">"Spice up your deck with our exclusive card collectibles!"</p>
    </div>
    <section class="py-5">
        <div class="container py-5">
            ...
            ?>
                <div class="col-lg-4 mb-4 card-item">
                ...
                echo "No products found in the 'Cards' category.";
            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        searchInput.addEventListener('input', function() {
            ...
            var cards = cardsContainer.getElementsByClassName('card-item');
