...
<body>
    ...
    <div class="col-md-8 col-xl-6 text-center mx-auto">
        <h1 class="fw-bold bounce animated" style="color: rgb(25, 245, 170);">Plushies</h1>
        <p class="text-muted">"Embrace our cute and cuddly selection of fluffy companions!"</p>
    </div>
    ...
    <section class="py-5">
        <div class="container py-5">
            ...
            <div id="plushiesContainer" class="row">
                <?php
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                ?>
                <div class="col-lg-4 mb-4 plushie-card">
                ...
                <?php
                    ...
                    echo "No products found in the 'Plushies' category.";
                }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        var plushiesContainer = document.getElementById('plushiesContainer');

        searchInput.addEventListener('input', function() {
            var filter = searchInput.value.toLowerCase();
            var plushies = plushiesContainer.getElementsByClassName('plushie-card');

            Array.from(plushies).forEach(function(plushie) {
                var title = plushie.querySelector('.card-title').textContent.toLowerCase();
                var description = plushie.querySelector('.card-text').textContent.toLowerCase();
